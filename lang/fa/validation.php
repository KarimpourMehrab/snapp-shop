...
return [
    ...
    */
    ...
    'custom' => [
        'transaction' => [
            'maximum_remittance_amount_rule' => 'حداکثر مبلغ تراکنش باید کمتر از :attribute تومان باشد ',
            'minimum_remittance_amount_rule' => 'حداقل مبلغ تراکنش باید بیشتر از :attribute تومان باشد ',
        ],
        'account' => [
            'balance_gt' => 'با توجه به موجودی حساب شما، حداکثر مبلغ قابل انتقال :attribute است'
        ]
    ],
